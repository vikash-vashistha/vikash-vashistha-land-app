    ...
    <Stack w="20%">
      ...
      <Stack>
        <Checkbox
          ...
          value="east"
          defaultChecked={category.includes("east")}
        >
          east
        </Checkbox>
        <Checkbox
          onChange={handleCheckbox}
          value="west"
          defaultChecked={category.includes("west")}
        >
          west
        </Checkbox>
        <Checkbox
          onChange={handleCheckbox}
          value="north"
          defaultChecked={category.includes("north")}
        >
          north
        </Checkbox>
        <Checkbox
          onChange={handleCheckbox}
          value="south"
          defaultChecked={category.includes("south")}
        >
          south
        </Checkbox>
      </Stack>
